...
fichier_tellus<-read_ods(path=system.file(package = "funcampR","data","recensement_agricole_statia_Tellus.ods"))
# fichier_galia<-read_ods(path="E:/icaRius/data/recensement_agricole_statia_Galia.ods")
fichier_galia<-read_ods(path=system.file(package = "funcampR","data","recensement_agricole_statia_Galia.ods"))
```
