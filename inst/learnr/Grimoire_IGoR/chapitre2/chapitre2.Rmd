...
file.copy(from = system.file(package = "funcampR","dataset","registre_pontes.csv"),
...
mon_fichier <- read.csv(system.file(package = "funcampR","dataset","pontes.csv"), sep=",")
```
...
```{r,  echo=FALSE}
mon_fichier <- read.csv(file=system.file(package = "funcampR","dataset","pontes.csv"), sep=",")
```
...
```{r,  echo=FALSE}
registre <- read.csv(file=system.file(package = "funcampR","dataset","registre_pontes.csv"), sep=",")
```
